...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                style={'width': '.8', 'padding': '3px', 'fontsize': '20px', 'text-align-last': 'center'},
                                searchable=True
                                ),
...
def get_scatter_plot(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site']==entered_site]
        filtered_df1 = filtered_df[filtered_df['Payload Mass (kg)'] >=  payload[0]]
        filtered_df2 = filtered_df1[filtered_df1['Payload Mass (kg)'] <=  payload[1]]
        print(filtered_df)
        print(filtered_df1)
        print(filtered_df2)
